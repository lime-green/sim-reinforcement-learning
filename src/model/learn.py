...
def learn():
    env_kwargs = dict(sim_duration=45, reward_type="delta_damage", mask_invalid_actions=True)
    ...
    print(evaluate_policy(model, model.get_env(), n_eval_episodes=1, deterministic=False, render=False, callback=policy_callback))
